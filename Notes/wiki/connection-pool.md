...
Cross-references: [sqlite-startup.md](sqlite-startup.md), [cancellation-infrastructure.md](cancellation-infrastructure.md), [prelease-cancellation.md](prelease-cancellation.md), [source-code.md](source-code.md), [unit-tests.md](unit-tests.md).
