...
Cross-references: Issues #24 (count), #30 (positional cache), #31 (byte cap), #33 (this work); [concurrent-page-count.md](concurrent-page-count.md), [positional-result-cache.md](positional-result-cache.md), [byte-cap-oversized-values.md](byte-cap-oversized-values.md), [scoped-select-cancellation.md](scoped-select-cancellation.md).
