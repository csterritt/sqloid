## Issue 41: Finalize shared typed rendering for exporters
...
- [ ] Given Issue 19's package-shaped rendering seam, then it remains the shared implementation consumed by the grid and exposed to exporters without relocation or duplication.
