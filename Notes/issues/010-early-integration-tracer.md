...
This tracer is disposable: once Issue 22 (first end-to-end SELECT with the real builder) lands, this code path is replaced. It does not need to handle paging, cancellation, history, or error recovery beyond a basic error display.
