...
- [ ] Given a typed value for standalone rendering, then the shared renderer emits exact decimal INTEGER, PRD-formatted finite REAL, safely quote-doubled TEXT, `NULL`, or `X'hex'` as applicable; Issues 36 and 42 consume this renderer rather than defining private serializers.
