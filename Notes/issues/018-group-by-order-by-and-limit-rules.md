...
- [ ] Given nonempty LIMIT input that is zero, negative, malformed, or above 9,223,372,036,854,775,807, then it is invalid and Issue 19 focuses Limit with exactly `Limit must be an integer from 1 to 9223372036854775807` when execution is attempted.
