## Issue 16: Ordered projection editing and deduplication
...
- [ ] Given the bare `COUNT(*)` sentinel and a subsequently selected named aggregate entry, then they coexist as distinct entries; Issue 15 hides the sentinel from a nonempty popup, and the QueryBuilder defensively rejects an identical sentinel transition invoked outside that UI path.

### User stories addressed

- User story 26: Preserve valid ordered projection entries
- User story 27 (projection-removal portion): Remove the latest projection safely
